...
conf t
 ...
 ip dhcp pool WIFIDATA
  ...
  dns-server 10.11.1.8
  domain-name WIFIDATA.COM 
  option 43 ip 10.11.1.7
  end
~~~
...
| NetAdapter 2         | __Bridged (Replicate)__ | 10.11.1.0 /24 |
...
conf t
 ...
 vlan 10
  ...
  exit
 int vlan 1
  ip add 10.11.1.7 255.255.255.0
  no shut
 int g1
  no switchport
...
- Wireless Management IP __[22]__ : `10.11.1.7`  
...
- Network Name* __[25]__ : `wireless-11`  
...
## Exercise 01: Configure `Wireless-11` so that client traffic belongs to VLAN 10.
...
Click on the existing WLAN, `wireless-11` __[05]__
...
Assign the DHCP server for the WLAN, `10.11.10.4` __[19]__
...
- Set the WLAN Profile to `wireless-11` __[26]__
...
- Use the available network address 10.11.11.0/24  
...
S: 32 - 6 = /26 (4th, 64i)  
I:  
  - 10.11.11.0 255.255.255.192  
  - 10.11.11.64 255.255.255.192   

<br>

__NETWORK ADDRESS: `10.11.11.0 255.255.255.192`__  
...
conf t
 ...
 int vlan 11
  ...
  ip add 10.11.11.4 255.255.255.192
  ip ospf 1 area 0
  no shut
 !
 ip dhcp excluded-address 10.11.11.1 10.11.11.10
 ip dhcp pool SOC-GROUP
  network 10.11.11.0 255.255.255.192
  default-router 10.11.11.4
...
- Use the available network address 10.11.12.0/24  
- Reserve the first 10 IPs  
...
S: 32 - 5 = /27 (4th, 32i)  
I:  
  - 10.11.12.0 255.255.255.224  
  - 10.11.12.32 255.255.255.224  

<br>

__NETWORK ADDRESS: `10.11.12.0 255.255.255.224`__  
...
conf t
 ...
 int vlan 11
  ...
  ip add 10.11.12.4 255.255.255.224
  ip ospf 1 area 0
  no shut
 !
 ip dhcp excluded-address 10.11.12.1 10.11.12.10
 ip dhcp pool NOC-GROUP
  network 10.11.12.0 255.255.255.224
  default-router 10.11.12.4
